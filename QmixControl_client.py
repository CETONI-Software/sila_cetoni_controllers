...
:file:    QmixControl_client.py
:authors: Florian Meinicke

:date: (creation)          2020-10-08T09:17:41.403351
:date: (last modification) 2021-07-09T07:00:13.381318
...
from impl.de.cetoni.controllers.ControlLoopService.ControlLoopService_client import ControlLoopServiceClient
...
class QmixControlClient(SystemStatusClient):
    ...
    def __init__(self,
                 name: str = "QmixControlClient", description: str = "The SiLA 2 driver for Qmix Control Devices",
...
def parse_command_line():
    ...
    """
    parser = argparse.ArgumentParser(description="A SiLA2 client: QmixControl")
