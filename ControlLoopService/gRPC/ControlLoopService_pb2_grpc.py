...
class ControlLoopServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.WriteSetPoint = channel.unary_unary(
                '/sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService/WriteSetPoint',
        ...
        self.RunControlLoop = channel.unary_unary(
                '/sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService/RunControlLoop',
        ...
        self.RunControlLoop_Info = channel.unary_stream(
                '/sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService/RunControlLoop_Info',
        ...
        self.RunControlLoop_Result = channel.unary_unary(
                '/sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService/RunControlLoop_Result',
                request_serializer=SiLAFramework__pb2.CommandExecutionUUID.SerializeToString,
        ...
        self.StopControlLoop = channel.unary_unary(
                '/sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService/StopControlLoop',
        ...
        self.Subscribe_ControllerValue = channel.unary_stream(
                '/sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService/Subscribe_ControllerValue',
...
def add_ControlLoopServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService', rpc_method_handlers)
...
class ControlLoopService(object):
    ...
    def WriteSetPoint(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService/WriteSetPoint',
    ...
    def RunControlLoop(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService/RunControlLoop',
    ...
    def RunControlLoop_Info(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService/RunControlLoop_Info',
    ...
    def RunControlLoop_Result(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService/RunControlLoop_Result',
            SiLAFramework__pb2.CommandExecutionUUID.SerializeToString,
    ...
    def StopControlLoop(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sila2.de.cetoni.pumps.syringepumps.controlloopservice.v1.ControlLoopService/StopControlLoop',
